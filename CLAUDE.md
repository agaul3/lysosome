...
Milestones 1–7 are complete; Milestone 8 (progression feedback: XP HUD, floating XP, audio, streaks, level-ups) is next, then the Knowledge interface, UI polish and save/load. Do not treat foundations from earlier milestones as completed versions of those features. Sprint is a Minecraft-style double-tap of a movement key.
