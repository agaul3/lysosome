...
Milestones 1–6 are complete; Milestone 7 is in progress (auditorium Hall A, seating, lecture camera, professor presentation and the competitive-antagonism visualization are done; see `CHANGELOG.md`). The lecture delivery UI, full question set, save/load, and later progression features remain future work. Do not treat foundations from Milestones 5–6 as completed versions of those features.
