...
Milestones 1–6 are complete; Milestone 7 is in progress (Hall A seating done; see `CHANGELOG.md`). The lecture delivery UI, full question set, save/load, and later progression features remain future work. Do not treat foundations from Milestones 5–6 as completed versions of those features.
