...
Milestones 1–9 are complete; Milestone 10 (UI + polish, remaining menu pages, save/load) is next. Do not treat foundations from earlier milestones as completed versions of those features. Sprint is a Minecraft-style double-tap of a movement key.
