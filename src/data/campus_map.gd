...
## Campus plus University Hospital across the street (to the south).
const BOUNDS := Rect2(-39, -37, 76, 96)
...
const PATHS := [
	...
	[26, 11, 30.5, 14], [27.5, 14, 30.5, 37],
]
## The street between the campus and the hospital.
const STREET := [-39, 27, 37, 35]
const PLAZAS := [[-17, -24.7, 17, -15], [-22, -7, -15, 4], [17, -22, 36, -14], [15, -11, 20.5, 5], [-20, -24, -15, -15], [-32, 37, 24, 44], [24, 37, 36.5, 58]]
...
const BUILDINGS := {
	...
	"hospital": ["University Hospital", -32.0, 44.0, 27.5, 59.0, "hospital"],
}
## Doors the player can use: [label, x, z]
const ENTRANCES := [["Learning Center", 0.0, -23.4], ["Cedar Residence", -21.4, -2.0], ["University Hospital", 27.8, 50.0]]
